	...
	protected void importData(final ProgressCallback<ImportStatus> progressionCallback, String... additionalsArgs) throws Exception {
		...
		try (Connection conn = BAT.getConnection()) {
			...
			while (res.next()) {
				...
				/*
				 * For unknown reason BungeeBans table contained (hardly ever but it did) date with a year > 3000, not sure if that was some kind of joke from a staff member ... Anyways this code
				 * convert long-duration tempban to definitive ban
				 */
