...
public class MojangAPIProvider {
	 ...
	 *             | if any error is met or if the server is offline mode */
	public static List<String> getPlayerNameHistory(final String pName) throws RuntimeException {
		...
		try {
			...
			for (final Map<String, Object> entry : (Set<Map<String, Object>>) gson.fromJson(content, new TypeToken<Set<Map<String, Object>>>() {}.getType()))
